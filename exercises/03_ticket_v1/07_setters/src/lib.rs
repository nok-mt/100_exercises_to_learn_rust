...
impl Ticket {
    ...
    pub fn set_title(self: &mut Ticket, new_title: String) -> () {
        Self::validate_title(&new_title);
        self.title = new_title.to_string()
    }

    pub fn set_description(self: &mut Ticket, new_description: String) -> () {
        Self::validate_description(&new_description);
        self.description = new_description.to_string()
    }

    pub fn set_status(self: &mut Ticket, new_status: String) -> () {
